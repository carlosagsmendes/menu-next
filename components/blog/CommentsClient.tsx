...
import type { CommentSort, NewCommentInput, Comment } from "@/data/dto";

async function createComment(postId: string, input: NewCommentInput): Promise<Comment> {
...
export function CommentsClient({
  ...
  const { data: comments, error, isFetching } = useSuspenseQuery(
