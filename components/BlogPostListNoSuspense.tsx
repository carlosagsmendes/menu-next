...
export function BlogPostListNoSuspense() {
              ...
              {isLoaderRow ? (
                ...
                <article className="mx-auto max-w-3xl border-b border-zinc-200 px-2 py-5 dark:border-zinc-800">
                  <div className="flex items-center gap-3">
                    <span
                      className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${post ? (CATEGORY_COLORS[post.category] ?? "bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300") : ""}`}
                    >
                      {post?.category}
                    </span>
